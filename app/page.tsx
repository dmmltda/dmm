...
export default function Page() {
        return (
                  <main className="min-h-screen bg-[var(--bg-body-dark)]">
                        {/* Header */}
                        <header className="sticky top-0 z-50 bg-[var(--bg-body-dark)]/80 backdrop-blur-md border-b border-[var(--bg-elevated)]">
                                <div className="mx-auto max-w-7xl px-6 lg:px-8 h-20 flex items-center justify-between">
                                          ...
                                          <nav className="hidden md:flex items-center gap-8">
                                                      ...
                                                      <a href="#galeria" className="text-sm font-medium text-[var(--text-secondary)] hover:text-[var(--accent)] transition-colors">Galeria</a>a>
                        ...
                        <Section className="relative overflow-hidden pt-20 pb-32">
                                <div className="grid lg:grid-cols-2 gap-12 items-center">
                                          <div>
                                                      ...
                                                      <h1 className="text-display mb-6 tracking-tight">Importacao Premium de Carros de Luxo com discricao e seguranca.</h1>h1>
                                ...
                                <div className="flex flex-col lg:flex-row gap-12 items-center p-8 lg:p-16">
                                          ...
                                          <div className="flex-1 w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                                                       <div className="aspect-[3/4] relative rounded-[var(--radius-lg)] border border-white/5 overflow-hidden shadow-2xl">
                                                                        <Image src="/purosangue-neymar.jpg" alt="Ferrari Purosangue Case" fill className="object-cover" />
                                                       </div>div>
                                                       <div className="aspect-[3/4] relative rounded-[var(--radius-lg)] border border-white/5 overflow-hidden shadow-2xl translate-y-8">
                                                                        <Image src="/purosangue-1.jpg" alt="Ferrari Purosangue Entrega" fill className="object-cover" />
                                                       </div>div>
                                          </div>div>
                                </div>div>
                        </Section>Section>
                        ...
                        <Section id="galeria">
                                <div className="mb-16 text-center max-w-3xl mx-auto">
                                          ...
                                          <p className="text-body text-[var(--text-secondary)]">Acompanhe a riqueza de detalhes de um projeto conduzido com excelencia.</p>p>
                                </div>div>
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
                                          <div className="grid gap-4 md:gap-6">
                                                      <div className="aspect-[4/5] relative rounded-[var(--radius-md)] overflow-hidden border border-white/5 shadow-lg group">
                                                                    <Image src="/purosangue-2.jpg" alt="D1" fill className="object-cover group-hover:scale-110 transition-transform duration-700" />
                                                      </div>div>
                                                      <div className="aspect-square relative rounded-[var(--radius-md)] overflow-hidden border border-white/5 shadow-lg group">
                                                                    <Image src="/purosangue-3.jpg" alt="D2" fill className="object-cover group-hover:scale-110 transition-transform duration-700" />
                                                      </div>div>
                                          </div>div>
                                          <div className="grid gap-4 md:gap-6 pt-8 md:pt-12">
                                                      <div className="aspect-square relative rounded-[var(--radius-md)] overflow-hidden border border-white/5 shadow-lg group">
                                                                    <Image src="/purosangue-4.jpg" alt="D3" fill className="object-cover group-hover:scale-110 transition-transform duration-700" />
                                                      </div>div>
                                                      <div className="aspect-[4/5] relative rounded-[var(--radius-md)] overflow-hidden border border-white/5 shadow-lg group">
                                                                    <Image src="/purosangue-5.jpg" alt="D4" fill className="object-cover group-hover:scale-110 transition-transform duration-700" />
                                                      </div>div>
                                          </div>div>
                                          <div className="grid gap-4 md:gap-6">
                                                      <div className="aspect-[3/4] relative rounded-[var(--radius-md)] overflow-hidden border border-white/5 shadow-lg group">
                                                                    <Image src="/purosangue-6.jpg" alt="D5" fill className="object-cover group-hover:scale-110 transition-transform duration-700" />
                                                      </div>div>
                                                      <div className="aspect-[4/3] relative rounded-[var(--radius-md)] overflow-hidden border border-white/5 shadow-lg group">
                                                                    <Image src="/purosangue-7.jpg" alt="D6" fill className="object-cover group-hover:scale-110 transition-transform duration-700" />
                                                      </div>div>
                                          </div>div>
                                          <div className="grid gap-4 md:gap-6 pt-4 md:pt-6">
                                                      <div className="aspect-video relative rounded-[var(--radius-md)] overflow-hidden border border-white/5 shadow-lg group">
                                                                    <Image src="/purosangue-8.jpg" alt="D7" fill className="object-cover group-hover:scale-110 transition-transform duration-700" />
                                                      </div>div>
                                                      <div className="aspect-[3/4] relative rounded-[var(--radius-md)] overflow-hidden border border-white/5 shadow-lg group">
                                                                    <Image src="/purosangue-9.jpg" alt="D8" fill className="object-cover group-hover:scale-110 transition-transform duration-700" />
                                                      </div>div>
                                          </div>div>
                                </div>div>
                        </Section>Section>
                        ...
                        <footer className="py-24 border-t border-[var(--bg-elevated)] bg-[var(--bg-body-dark)]">
                                <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center md:text-left">
                                           ...
                                           <p className="text-sm text-[var(--text-muted)]">(c) 2026 DMM Luxury Cars | Todos os direitos reservados.</p>p>
                                </div>div>
                        </footer>footer>
                  </main>main>
                );
